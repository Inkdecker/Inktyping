...
# Form implementation generated from reading ui file 'D:\Desktop\ART TUTORIALS\SHORTCUTS & STUFF\Inktyping\ui\main_window.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(590, 740)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(590, 740))
        MainWindow.setMaximumSize(QtCore.QSize(590, 740))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/Inktyping.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.horizontalLayout_4.setContentsMargins(-1, -1, 230, -1)
        ...
        self.theme_options_button.setMaximumSize(QtCore.QSize(73, 20))
        ...
        self.verticalLayout_8.addWidget(self.theme_options_button)
        self.labels_options_button = QtWidgets.QPushButton(self.centralwidget)
        self.labels_options_button.setMinimumSize(QtCore.QSize(73, 20))
        self.labels_options_button.setMaximumSize(QtCore.QSize(73, 20))
        self.labels_options_button.setStyleSheet("background: rgb(220,220,220); color: \'black\';")
        self.labels_options_button.setObjectName("labels_options_button")
        self.verticalLayout_8.addWidget(self.labels_options_button)
        ...
        self.table_sentences_selection.setMinimumSize(QtCore.QSize(300, 300))
        self.table_sentences_selection.setMaximumSize(QtCore.QSize(500, 300))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.search_preset.setFocusPolicy(QtCore.Qt.TabFocus)
        ...
        self.verticalLayout_3.setContentsMargins(10, 14, -1, 0)
        ...
        self.table_session_selection.setMaximumSize(QtCore.QSize(600, 540))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Sentence practice - Inktyping"))
        self.label.setText(_translate("MainWindow", "<html><head/><body><p><img src=\":/icons/icons/Inktyping_48x48.png\"/></p></body></html>"))
        ...
        self.add_folders_button.setText(_translate("MainWindow", "Create Preset"))
